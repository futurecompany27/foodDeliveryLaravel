...
class Order extends Model
{
    ...
    protected $fillable = [
        ...
        'driver_service_charge_amount',
        'driver_service_charge_taxes',
        'grand_total',
        'user_id',
        'shipping_address',
        'city',
    ...
    public function generateOrderSummaryData()
    {
        ...
        return [
            ...
            'chef_service_charges' => $adminSettings->chef_service_charges,
            'driver_service_charges' => $adminSettings->driver_service_charges,
