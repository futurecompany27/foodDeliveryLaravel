...
class DriverScheduleCallNotification extends Notification
{
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'message' => ($this->ScheduleCall['driver']['firstName'] . ' ' . $this->ScheduleCall['driver']['lastName']) . ' has requested for call on ' . date('d M Y', strtotime($this->ScheduleCall['date'])) . ' between ' . $this->ScheduleCall['slot'] . '.',
            'url' => '/admin/driver-call-request'
        ];
    }
}
