...
class FoodCertificateNotification extends Notification
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'message' => (($this->chefDetail['firstName'] . ' ' . $this->chefDetail['lastName']) . ' Food Certificate Status Changed. ' . date('d M Y', strtotime($this->chefDetail->created_at)) . '.'),
