...
class FoodItemSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('food_items')->insert([
            ...
            'dishImage' => 'http://127.0.0.1:8000/storage/foodItem/pasta.jpeg',
            'dishImageThumbnail' => 'http://127.0.0.1:8000/storage/foodItem/thumbnail/pasta.jpeg',
            'regularDishAvailabilty' => 'No Limits',
            "foodAvailibiltyOnWeekdays" => json_encode(['Su', 'M', 'T', 'W', 'Th', 'F', 'S']),
            'orderLimit' => "10",
            'foodTypeId' => '2',
        ...
        DB::table('food_items')->insert([
            ...
            'dishImage' => 'http://127.0.0.1:8000/storage/foodItem/sev puri.jpeg',
            'dishImageThumbnail' => 'http://127.0.0.1:8000/storage/foodItem/thumbnail/sev puri.jpeg',
            'regularDishAvailabilty' => 'No Limits',
            "foodAvailibiltyOnWeekdays" => json_encode(['Su', 'M', 'T', 'W', 'Th', 'F', 'S']),
            'orderLimit' => "10",
            'foodTypeId' => '3',
